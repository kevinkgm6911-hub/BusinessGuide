    ...
    <div className="py-10 sm:py-12 lg:py-16">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-gray-100">
        ...
        <header className="mb-8 sm:mb-10">
          ...
          <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-300 max-w-2xl">
          ...
          <div className="mt-5 sm:mt-6">
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={handleReset}
                className="ml-auto rounded-lg border border-neutral-700 bg-neutral-900 px-3 py-1.5 text-[11px] sm:text-xs text-neutral-300 hover:border-neutral-600"
              >
                Reset
              </button>
            </div>
            ...
            <div className="mt-4">
              {next ? (
                <button
                  ...
                  className="rounded-xl bg-gradient-to-r from-orange-500 to-pink-500 px-4 sm:px-5 py-2 text-xs sm:text-sm font-semibold shadow-lg shadow-orange-500/20 hover:opacity-95"
                >
        ...
        {/* Cards */}
        <ol className="grid gap-5 sm:gap-6 md:grid-cols-2">
            ...
            return (
              <li key={slug} className="relative">
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl font-bold">{meta.title}</h3>
                  ...
                  <div className="mt-4 sm:mt-5 flex flex-wrap items-center gap-2 sm:gap-3">
                    <button
                      ...
                      className="inline-flex items-center rounded-lg bg-orange-600 px-3 py-1.5 text-xs sm:text-sm font-semibold hover:bg-orange-700"
                    >
                      Open guide →
                    </button>
                    <button
                      ...
                      className={`rounded-lg border px-3 py-1.5 text-[11px] sm:text-xs ${
                        done
      ...
      {/* Toast */}
      {showToast && (
        <div className="fixed bottom-4 right-4 z-40 max-w-[90vw] sm:max-w-xs">
          <div className="rounded-xl border border-pink-500/30 bg-gray-900/95 p-4 shadow-xl">
